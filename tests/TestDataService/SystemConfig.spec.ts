import { test, expect, type APIResponse, type SystemConfig } from "../../src";

test("System config can be overwritten and is restored to defaults", async ({ AdminApiContext, TestDataService, DefaultSalesChannel }) => {
