...
export const AddProductToCart_a11y = base.extend<{ AddProductToCart_a11y: Task }, FixtureTypes>({
    AddProductToCart_a11y: async ({ ShopCustomer, StorefrontProductDetail }, use) => {
